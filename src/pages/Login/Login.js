                ...
                <form onSubmit={handleSubmit(handleLogin)} className="space-y-12 ng-untouched ng-pristine ng-valid">
                    <div className="space-y-4">
                        <div>
                            ...
                            {...register('email', {required : "write a registered email"})}
                            />
                    ...
                    <div className="space-y-2">
                        <div>
                            <button type="submit" className="w-full px-8 py-3 font-semibold rounded-md bg-primary text-gray-50">Sign In</button>
                        </div>
                    </div>
                </form>
