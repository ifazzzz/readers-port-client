        ...
        <div>
            <div className="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
                <div className="max-w-xl mb-10 md:mx-auto sm:text-center lg:max-w-2xl md:mb-12">
                    <div>
                    <p className="inline-block px-3 py-px mb-4 text-xs font-semibold tracking-wider text-primary uppercase rounded-full bg-secondary">
                        Readers Port
                    </p>
                    </div>
                    ...
                    from buyers and sellers of Readers Port
                    </h2>
                    <p className="text-base text-gray-700 md:text-lg">
                    If you want to know more about us see reviews from our previous customers. feel free to leave your own feedback
                    </p>
                </div>
